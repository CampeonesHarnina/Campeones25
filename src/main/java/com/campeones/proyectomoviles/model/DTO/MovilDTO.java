...
public record MovilDTO(Long id, String marca, String modelo, int almacenamiento, float tamanioPantalla,
		AspectRatio aspectRatio, TecnologiaPantalla tecnologiaPantalla, int ram, float peso, int camara, int bateria,
		int nfc, float precioActual, LocalDate fechaLanzamiento, int consultas, int proporcionAlto, int proporcionAncho,
		ResolucionTarget resolucionTarget, Resolucion resolucion, String dimensionesMovil, Procesador procesador) {
}
