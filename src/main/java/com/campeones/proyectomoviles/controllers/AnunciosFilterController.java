...
public class AnunciosFilterController
	...
	@Override
	public ResponseEntity<AnuncioDTO> addToUser(@Valid @RequestBody AnuncioDTO add,
	...
	@Override
	public ResponseEntity<AnuncioDTO> updateByUser(@Valid @RequestBody AnuncioDTO put,
			@RequestHeader("Authorization") String token) {
